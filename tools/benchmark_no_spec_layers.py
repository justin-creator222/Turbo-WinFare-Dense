...
RESULTS_JSON = ROOT / "build" / "no_spec_layer_benchmark_results.json"
...
def main():
    ...
    all_results = []
    print("Starting Gemma 4 31B Pure Autoregressive (No MTP) Layer Configuration Benchmark Suite...", flush=True)
